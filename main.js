    ...
    ws.addEventListener("message", e => {
        ...
        switch (msg.e) {
            ...
            case "join":
                ...
                break;
            case "message":
                if (["NKY", "NKY5223", "NKYv2", "NKYv3", "NKYv4", "3225YKN", "ZeroTix", "ZeroFix", "wolfie", "HayrenRyzm", "RayhanADev"].includes(msg.m.s) && !["NKY", "NKY5223", "NKYv2", "NKYv3", "NKYv4", "3225YKN"].includes(user)) {
